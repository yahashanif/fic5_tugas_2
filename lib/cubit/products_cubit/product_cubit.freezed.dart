...
class _$_Loaded implements _Loaded {
  const _$_Loaded(
      {required final List<ProductResponseModel> data,
      this.offset = 0,
      this.limit = 50,
      this.isNext = false})
      : _data = data;
  ...
  @override
  String toString() {
    return 'ProductState.loaded(data: $data, offset: $offset, limit: $limit, isNext: $isNext)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_data), offset, limit, isNext);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(data, offset, limit, isNext);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(data, offset, limit, isNext);
  }
